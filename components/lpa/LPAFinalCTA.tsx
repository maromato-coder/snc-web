...
export default function LPAFinalCTA() {
    ...
    const handleSubmit = () => {
        ...
        //    (예: fetch로 이메일 전송 API / DB 저장)
        // ════════════════════════════════════════════
        console.log("[가맹 신청 데이터]", form)
        ...
        >
            ...
            >
                ...
                <div>
                    ...
                    >
                        지금 신청하면 90일 무료로 모든 시스템을 경험합니다.
                        부담 없이 시작하고, 직접 겪어본 뒤 결정하세요.
                    </p>
                        ...
                        <>
                            ...
                            <p
                                style={{
                                    ...
                                    margin: m ? "0 0 24px 0" : "0 0 28px 0",
                                    lineHeight: 1.5,
                                }}
                            >
                            ...
                            <div style={{ display: "flex", flexDirection: "column", gap: m ? 14 : 16 }}>
                                ...
                                {error && (
                                    <div style={{ fontSize: 13, color: "#FF6B6B", marginTop: -4 }}>
                                        {error}
                                    </div>
                                )}
