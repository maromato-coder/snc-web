            ...
            <div style={{ maxWidth: 1280, margin: "0 auto" }}>
                ...
                <div
                    style={{
                        ...
                        gridTemplateRows: "180px 60px 180px",
                        position: "relative",
                        columnGap: 0,
                    }}
                >
                    ...
                    >
                        {/* SVG Line - past solid + future dashed */}
                        <svg
                            viewBox="0 0 700 4"
    ...
    return (
        <div
            ...
            style={{
                ...
                maxWidth: 160,
                boxShadow: isCurrent
                    ? "0 16px 36px rgba(0, 102, 255, 0.30)"
                    : hover
                    ? "0 8px 20px rgba(10, 23, 51, 0.08)"
            ...
            >
                ...
                <div
                    style={{
                        ...
                        background: "#0066FF",
                        borderRadius: "50%",
                        boxShadow: "0 0 0 4px #FFFFFF, 0 0 0 6px #0066FF",
                        position: "relative",
                        zIndex: 1,
                    }}
                />
